Title: GitHub - dominikhei/cardamon: Cardamon is a cleanup tool for Prometheus that collects unused metrics from Grafana and Prometheus and generates drop statements for them.

URL Source: https://github.com/dominikhei/cardamon

Markdown Content:
[![Image 1: CI](https://camo.githubusercontent.com/14d5e1ecfc8a16fc3c6a486d12fa17e619dd89b36bded2853ddb49cf136e631f/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f676f2d6d6f642f676f2d76657273696f6e2f646f6d696e696b6865692f63617264616d6f6e)](https://go.dev/doc/devel/release)[![Image 2: CI](https://github.com/dominikhei/serverless-statistics/actions/workflows/ci.yml/badge.svg)](https://github.com/dominikhei/serverless-statistics/actions/workflows/ci.yml)
...
[](https://github.com/dominikhei/cardamon#demo)
[![Image 3](https://github.com/dominikhei/cardamon/raw/main/media/cardamon_demo.gif)](https://github.com/dominikhei/cardamon/blob/main/media/cardamon_demo.gif)

## What is an Unused Metric?

[](https://github.com/dominikhei/cardamon#what-is-an-unused-metric)
...
[](https://github.com/dominikhei/cardamon#installing-cardamon)
...
[](https://github.com/dominikhei/cardamon#how-it-works)
...
[](https://github.com/dominikhei/cardamon#configuration)
...
[](https://github.com/dominikhei/cardamon#enabling-the-prometheus-query-log)
Cardamon scans the Prometheus query log to discover which metrics are actually being queried. You have to copy those files to your instance or start cardamon inside the Prometheus server to use them, as cardamon can not query them on another host. They [need to be enabled](https://prometheus.io/docs/guides/query-log/), e.g via your values.yaml.
...
[](https://github.com/dominikhei/cardamon#usage)
...
[](https://github.com/dominikhei/cardamon#the-ui)
The UI gives you a full picture of your unused metrics and lets you act on them.

### Metric table

[](https://github.com/dominikhei/cardamon#metric-table)
...
[](https://github.com/dominikhei/cardamon#search-and-sort)
...
[](https://github.com/dominikhei/cardamon#selecting-metrics)
...
[](https://github.com/dominikhei/cardamon#drop-rules)
...
[](https://github.com/dominikhei/cardamon#required-permissions)
### Prometheus

[](https://github.com/dominikhei/cardamon#prometheus)
...
[](https://github.com/dominikhei/cardamon#grafana)
...
[](https://github.com/dominikhei/cardamon#limitations)
...
[](https://github.com/dominikhei/cardamon#contributing)
