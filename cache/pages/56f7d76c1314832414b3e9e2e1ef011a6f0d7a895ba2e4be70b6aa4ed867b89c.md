Title: GitHub - elodin-sys/ai-grand-prix

URL Source: https://github.com/elodin-sys/ai-grand-prix

Markdown Content:
## AI Grand Prix Playground

[](https://github.com/elodin-sys/ai-grand-prix#ai-grand-prix-playground)
...
[![Image 1: AI Grand Prix demo flight](https://github.com/elodin-sys/ai-grand-prix/raw/main/drone_race_preview.gif)](https://github.com/elodin-sys/ai-grand-prix/blob/main/drone_race_preview.gif)
...
*   A clean [`solver/`](https://github.com/elodin-sys/ai-grand-prix/blob/main/solver) package. That's the only directory you edit to compete.

## Quick start (macOS / Linux, ~5 minutes)

[](https://github.com/elodin-sys/ai-grand-prix#quick-start-macos--linux-5-minutes)
...
[](https://github.com/elodin-sys/ai-grand-prix#writing-your-solver)
Edit [`solver/baseline.py`](https://github.com/elodin-sys/ai-grand-prix/blob/main/solver/baseline.py) or point at your own module:

RACE_SOLVER=my_team.my_solver elodin editor sim/main.py

The full contract (one `autopilot(update: SensorUpdate) -> RCCommand` function) is in [`solver/README.md`](https://github.com/elodin-sys/ai-grand-prix/blob/main/solver/README.md).

## Inspecting a run

[](https://github.com/elodin-sys/ai-grand-prix#inspecting-a-run)
...
The CSV form is convenient for regression diffs, offline plotting, or pulling state into a notebook. For lighter-weight queries on individual components without writing files, `elodin-db query --eql ...` hits the same DB; see [`ARCHITECTURE.md`](https://github.com/elodin-sys/ai-grand-prix/blob/main/ARCHITECTURE.md#determinism-timing-and-tests) for the syntax.

## Running tests

[](https://github.com/elodin-sys/ai-grand-prix#running-tests)
...
[](https://github.com/elodin-sys/ai-grand-prix#going-deeper)
*   [`ARCHITECTURE.md`](https://github.com/elodin-sys/ai-grand-prix/blob/main/ARCHITECTURE.md): full design covering the lockstep cycle, coordinate frames, module reference, editor schematic, configuration knobs, and known opportunities for improvement.
*   [`solver/README.md`](https://github.com/elodin-sys/ai-grand-prix/blob/main/solver/README.md): the autopilot contract.
...
[](https://github.com/elodin-sys/ai-grand-prix#acknowledgements)
...
[](https://github.com/elodin-sys/ai-grand-prix#license)
[Apache 2.0](https://github.com/elodin-sys/ai-grand-prix/blob/main/LICENSE), the same license as the upstream [Elodin engine](https://github.com/elodin-sys/elodin).