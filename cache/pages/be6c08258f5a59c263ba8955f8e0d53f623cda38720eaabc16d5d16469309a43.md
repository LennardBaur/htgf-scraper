Title: GitHub - feers77/iasql: A new implementation of SQL for IA purposes, using postgresSQL and Karpathy wiki-llm as inspiration.

URL Source: https://github.com/feers77/iasql

Markdown Content:
**Turn PostgreSQL into a self-compiling knowledge base.** An in-database implementation of Andrej Karpathy's _"LLM Wiki"_ pattern: you `INSERT` raw documents, and a background worker uses an external LLM to **compile** them into a maintained, cross-referenced Markdown wiki — then keeps auditing that wiki against the sources for hallucinations.

> Status: **0.1 — working proof of concept.** Built and tested on PostgreSQL 17. [Español aquí →](https://github.com/feers77/iasql/blob/main/README.es.md)

🌐 **Landing: [https://feers77.github.io/iasql](https://feers77.github.io/iasql)** · **Live wiki demo: [https://iasql.dev.feres.cl](https://iasql.dev.feres.cl/)** 📖 **New here? Start with the [tutorial by user profile](https://github.com/feers77/iasql/blob/main/docs/TUTORIAL.md).**

* * *

## The idea

[](https://github.com/feers77/iasql#the-idea)
...
[](https://github.com/feers77/iasql#how-it-works)
...
### Why PostgreSQL (and why the LLM stays _external_)

[](https://github.com/feers77/iasql#why-postgresql-and-why-the-llm-stays-external)
PostgreSQL's process model, **background workers**, **SPI**, **GUCs** and triggers make it an ideal host for an asynchronous compile loop. The heavy model inference, however, runs in a **separate, configurable OpenAI-compatible service** (local Ollama / llama.cpp, or a SaaS API). This keeps the database stable — a crash or OOM in a model never takes Postgres down — and lets you pick any model. IA-SQL is the _orchestrator in the engine_; the LLM is a swappable backend.

## Requirements

[](https://github.com/feers77/iasql#requirements)
...
[](https://github.com/feers77/iasql#install)
...
[](https://github.com/feers77/iasql#usage)
...
[](https://github.com/feers77/iasql#configuration-gucs)
| GUC | Default | Purpose |
| --- | --- | --- |
...
| `ia_sql.wiki_system_prompt` | _(built-in)_ | Layer-3 compiler directive |
| `ia_sql.lint_system_prompt` | _(built-in)_ | Layer-3 auditor directive |
| `ia_sql.max_attempts` | `3` | Retries before a job is marked `error` |

### Provider compatibility

[](https://github.com/feers77/iasql#provider-compatibility)
...
[](https://github.com/feers77/iasql#security-notes)
...
[](https://github.com/feers77/iasql#roadmap)
...
[](https://github.com/feers77/iasql#credits--license)
*   Concept: Andrej Karpathy's **LLM Wiki** pattern.
*   Bundles [cJSON](https://github.com/DaveGamble/cJSON) (MIT).
*   Licensed under the **MIT License** — see [LICENSE](https://github.com/feers77/iasql/blob/main/LICENSE).