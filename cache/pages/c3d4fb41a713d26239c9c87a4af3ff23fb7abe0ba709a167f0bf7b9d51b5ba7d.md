Title: GitHub - nikitph/yieldos

URL Source: https://github.com/nikitph/yieldos

Markdown Content:
## YieldOS-Lite MVP Simulator

[](https://github.com/nikitph/yieldos#yieldos-lite-mvp-simulator)
[![Image 1: YieldOS-Lite: When Scheduling Is Not Enough — Resource Governance for Heterogeneous LLM Inference](https://github.com/nikitph/yieldos/raw/master/assets/yieldos_overview.png)](https://github.com/nikitph/yieldos/blob/master/assets/yieldos_overview.png)
...
📄 **Read the paper:**[`paper/yieldos_lite_resource_governance_paper.pdf`](https://github.com/nikitph/yieldos/blob/master/paper/yieldos_lite_resource_governance_paper.pdf)

## What This Is

[](https://github.com/nikitph/yieldos#what-this-is)
...
[](https://github.com/nikitph/yieldos#where-to-start)
| If you want to... | Start here |
| --- | --- |
| Understand the research claim | [`paper/yieldos_lite_resource_governance_paper.pdf`](https://github.com/nikitph/yieldos/blob/master/paper/yieldos_lite_resource_governance_paper.pdf) |
| Inspect the LaTeX source | [`paper/yieldos_lite_resource_governance_paper.tex`](https://github.com/nikitph/yieldos/blob/master/paper/yieldos_lite_resource_governance_paper.tex) |
| Run the simulator | See [Quick Start](https://github.com/nikitph/yieldos#quick-start) |
| Understand trace replay | [`docs/trace_format.md`](https://github.com/nikitph/yieldos/blob/master/docs/trace_format.md) |
| See evaluation structure | [`docs/evaluation_outline.md`](https://github.com/nikitph/yieldos/blob/master/docs/evaluation_outline.md) |
| Inspect headline results | `runs/*/summary.json`, `runs/*/summary.csv`, and `runs/*/report.md` |
| Modify policies | [`src/yieldos/policies.py`](https://github.com/nikitph/yieldos/blob/master/src/yieldos/policies.py) |
| Modify the simulator loop | [`src/yieldos/simulator.py`](https://github.com/nikitph/yieldos/blob/master/src/yieldos/simulator.py) |
| Regenerate paper figures | [`scripts/generate_paper_figures.py`](https://github.com/nikitph/yieldos/blob/master/scripts/generate_paper_figures.py) |

## Repository Map

[](https://github.com/nikitph/yieldos#repository-map)
...
[](https://github.com/nikitph/yieldos#core-concepts)
...
[](https://github.com/nikitph/yieldos#what-to-believe)
...
[](https://github.com/nikitph/yieldos#current-research-status)
...
[](https://github.com/nikitph/yieldos#quick-start)
Use Python 3.11+.
...
[](https://github.com/nikitph/yieldos#completed-runs)
...
[](https://github.com/nikitph/yieldos#next-experiments)
...
[](https://github.com/nikitph/yieldos#further-sweeps)
...
[](https://github.com/nikitph/yieldos#interpretation-discipline)
...
[](https://github.com/nikitph/yieldos#trace-compatibility)
...
[](https://github.com/nikitph/yieldos#semi-realistic-profiles)
...
[](https://github.com/nikitph/yieldos#external-trace-pilot)
...
[](https://github.com/nikitph/yieldos#obligation-heterogeneity)
...
[](https://github.com/nikitph/yieldos#notes)
